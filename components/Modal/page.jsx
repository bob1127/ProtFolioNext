...
const Modal = ({ isOpen, onClose, imageSrc }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black overflow:hidden bg-opacity-75">
      <div
        ref={modalRef}
      ...
      >
        ...
        <div className="flex px-[10px] xl:px-[30px] xl:flex-row flex-col justify-center items-center h-full ">
          <div className="w-full border overflow-scroll border-white relative overflow-y-scroll h-full xl:w-1/2">
            <div className="img-wrap border border-white w-full mx-auto">
              <Image
                src={imageSrc}
