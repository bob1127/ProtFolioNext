...
const Section2 = ({ scrollYProgress }) => {
  ...
  return (
    <>
      <motion.div
        style={{ scale, rotate }}
        className="relative overflow-hidden md:h-[160vh] hidden xl:block z-[999999999] 2xl:h-[120vh]  h-screen"
        transition={{
          duration: 6.8,
      ...
      >
        ...
        <div className="border overflow-visible md:overflow-hidden  xl:pt-[250px] pt-[50px]   z-[-1] bg-[#001e5a]  h-[100vh]  md:h-[350vh] 2xl:h-[220vh] border-[#222222]  static rounded-[45px]  md:rounded-[60px] xl:rounded-[120px] 2xl:rounded-[120px]">
          ...
          <div className="txt  px-[25px] flex items-center flex-col justify-center py-4">
            ...
            <p className="text-[16px] font-normal text-center w-full mt-4 md:w-1/2 mx-auto md:text-[22px] text-[#f5f5f5]">
          ...
          >
            ...
            <div className="hidden  md:flex  md:flex-row flex-col">
              <a
                href="/3dProduct"
                data-aos-delay="300"
                className="group shadow-xl mt-[10px] md:mt-[500px] h-full md:h-auto relative shadow-black duration-100 bg-white group hover:bg-[#11203f] rounded-xl w-full md:w-1/3 group m-1 p-6"
              >
      ...
      <motion.div
        className="relative block mt-0   md:mt-[200px] xl:hidden z-[999999999]  h-[150vh] md:h-[200vh]"
        transition={{
          duration: 6.8,
          ease: [0.1, 3.7, 3.0, 3.1], // Custom cubic-bezier timing function
        }}
