    ...
    <div className="relative h-[70vh] md:h-full overflow-hidden">
      ...
      >
        <SwiperSlide className="flex justify-center items-center text-lg">
          <a
            href="/"
            className="bg-white border border-black shadow-[4px_4px_0px_rgba(0,0,0,0.25)] px-3 rounded-[14px] w-[200px] text-[14px] hover:shadow-[2px_2px_0px_rgba(0,0,0,0.85)] py-2"
          >
            產品攝影｜圖片後製
          </a>
        </SwiperSlide>
