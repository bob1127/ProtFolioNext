...
export const PrevButton = (props) => {
  ...
  return (
    <button
      ...
      {...restProps}
    >
      <div className="w-[100px] h-[100px] flex justify-center items-center rounded-full p-3">
        <img
          className="w-full"
          src="https://thumbs.dreamstime.com/b/right-arrow-vector-icon-black-symbol-navigation-163301987.jpg"
          alt=""
        />
      </div>
